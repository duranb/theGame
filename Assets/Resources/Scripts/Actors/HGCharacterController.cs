...
public class HGCharacterController : MonoBehaviour
{
	...
	/// </summary>
	public bool _usePhysicsForMovement = false;
	...
	/// </summary>
	public AnimationCurve _slopeSpeedMultiplier = new AnimationCurve( new Keyframe( -90, 1.5f ), new Keyframe( 0, 1 ), new Keyframe( 90, 0 ) );
	...
	[Range( 0.8f, 0.999f )]
	public float _triggerHelperBoxColliderScale = 0.95f;
	...
	public bool _isGrounded { get { return _collisionState.below; } }
	...
	public void move( Vector3 deltaMovement )
	{
		...
		if( deltaMovement.y < 0 && _collisionState.wasGroundedLastFrame )
	...
	private void moveVertically( ref Vector3 deltaMovement )
	{
		...
		if( isGoingUp && !_collisionState.wasGroundedLastFrame )
